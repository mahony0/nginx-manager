    ...
    jQuery(function($) {
        ...
        $.post("/ajax.php", {section: sect}, function(response) {
            ...
            if (response.status === 1) {
                ...
                if (!response.results.nginx_installed || !response.results.nginx_status) { $(".nginx_reload").hide(); $(".nginx_restart").hide(); }
                ...
                if (!response.results.apache_installed || !response.results.apache_status) { $(".apache_restart").hide(); }
                ...
                if (!response.results.postfix_installed || !response.results.postfix_status) { $(".postfix_restart").hide(); }
                ...
                if (!response.results.dovecot_installed || !response.results.dovecot_status) { $(".dovecot_restart").hide(); }
                ...
                if (!response.results.vsftpd_installed || !response.results.vsftpd_status) { $(".vsftpd_restart").hide(); }
                ...
                if (!response.results.proftpd_installed || !response.results.proftpd_status) { $(".proftpd_restart").hide(); }
                ...
                if (!response.results.ssh_installed || !response.results.ssh_status) { $(".ssh_restart").hide(); }
                ...
                if (!response.results.mysql_installed || !response.results.mysql_status) { $(".mysql_restart").hide(); }
                ...
                if (!response.results.php_installed || !response.results.php_status) { $(".php_restart").hide(); }
                ...
                if (!response.results.php56_installed || !response.results.php56_status) { $(".php56_restart").hide(); }
                ...
                if (!response.results.php70_installed || !response.results.php70_status) { $(".php70_restart").hide(); }
                ...
                if (!response.results.php71_installed || !response.results.php71_status) { $(".php71_restart").hide(); }
                ...
                if (!response.results.php72_installed || !response.results.php72_status) { $(".php72_restart").hide(); }
                ...
                if (!response.results.php73_installed || !response.results.php73_status) { $(".php73_restart").hide(); }
                ...
                if (!response.results.php74_installed || !response.results.php74_status) { $(".php74_restart").hide(); }
