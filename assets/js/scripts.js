    ...
    jQuery(function($) {
        ...
        $.post("/ajax.php", {section: sect}, function(response) {
            ...
            if (response.status === 1) {
                ...
                if (response.results.nginx_status === 1) { $(".nginx_status").removeClass("passive-server").removeClass("active-server"); }
                ...
                if (response.results.apache_status === 1) { $(".apache_status").removeClass("passive-server").removeClass("active-server"); }
                ...
                if (response.results.postfix_status === 1) { $(".postfix_status").removeClass("passive-server").removeClass("active-server"); }
                ...
                if (response.results.dovecot_status === 1) { $(".dovecot_status").removeClass("passive-server").removeClass("active-server"); }
                ...
                if (response.results.vsftpd_status === 1) { $(".vsftpd_status").removeClass("passive-server").removeClass("active-server"); }
                ...
                if (response.results.proftpd_status === 1) { $(".proftpd_status").removeClass("passive-server").removeClass("active-server"); }
                ...
                if (response.results.ssh_status === 1) { $(".ssh_status").removeClass("passive-server").removeClass("active-server"); }
                ...
                if (response.results.mysql_status === 1) { $(".mysql_status").removeClass("passive-server").removeClass("active-server"); }
                ...
                if (response.results.php_status === 1) { $(".php_status").removeClass("passive-server").removeClass("active-server"); }
                ...
                if (response.results.php56_status === 1) { $(".php56_status").removeClass("passive-server").removeClass("active-server"); }
                ...
                if (response.results.php70_status === 1) { $(".php70_status").removeClass("passive-server").removeClass("active-server"); }
                ...
                if (response.results.php71_status === 1) { $(".php71_status").removeClass("passive-server").removeClass("active-server"); }
                ...
                if (response.results.php72_status === 1) { $(".php72_status").removeClass("passive-server").removeClass("active-server"); }
                ...
                if (response.results.php73_status === 1) { $(".php73_status").removeClass("passive-server").removeClass("active-server"); }
                ...
                if (response.results.php74_status === 1) { $(".php74_status").removeClass("passive-server").removeClass("active-server"); }
